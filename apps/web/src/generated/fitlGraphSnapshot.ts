...
export const fitlGraphSnapshot: FitlGraphSnapshot = {
  "version": 1,
  "generatedAt": "2026-04-02T23:11:38.398Z",
  "sourceDocs": [
    "apps/web/README.md",
  ...
  "nodes": [
    {
      ...
      "kind": "decision",
      "label": "Deferred: Offline write queueing and conflict resolution",
      "summary": "Offline write queueing and conflict resolution",
      "lifecycle": "deferred",
      "system": "internal"
    },
    {
      ...
      "kind": "decision",
      "label": "Deferred: Cross-device sync conflict tooling beyond server-last behavior",
      "summary": "Cross-device sync conflict tooling beyond server-last behavior",
      "lifecycle": "deferred",
      "system": "internal"
    },
    {
      ...
      "kind": "decision",
      "label": "Deferred: Lichess imports",
      "summary": "Lichess imports",
      "lifecycle": "deferred",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "kind": "decision",
      "label": "Web v1 uses Convex-backed authenticated persistence with IndexedDB retained as a read cache and benchmark-only local store",
      "summary": "Web v1 uses Convex-backed authenticated persistence with IndexedDB retained as a read cache and benchmark-only local store.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "kind": "decision",
      "label": "Convex/auth is on the active runtime path, but compile/test/build checks must still run without requiring a live signed-in browser session",
      "summary": "Convex/auth is on the active runtime path, but compile/test/build checks must still run without requiring a live signed-in browser session.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/application/chessComImport.ts",
          "path": "apps/web/src/application/chessComImport.ts"
        }
      ],
      "tags": [
        "ts"
      ],
      "id": "file:apps/web/src/application/chessComImport.ts",
      "kind": "file",
      "label": "chessComImport.ts",
      "summary": "apps/web/src/application/chessComImport.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/application/chessComSyncCoordinator.ts",
          "path": "apps/web/src/application/chessComSyncCoordinator.ts"
        }
      ],
      "tags": [
        "ts"
      ],
      "id": "file:apps/web/src/application/chessComSyncCoordinator.ts",
      "kind": "file",
      "label": "chessComSyncCoordinator.ts",
      "summary": "apps/web/src/application/chessComSyncCoordinator.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/application/importGames.ts",
          "path": "apps/web/src/application/importGames.ts"
        }
      ],
      "tags": [
        "ts"
      ],
      "id": "file:apps/web/src/application/importGames.ts",
      "kind": "file",
      "label": "importGames.ts",
      "summary": "apps/web/src/application/importGames.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/domain/chessComArchives.ts",
          "path": "apps/web/src/domain/chessComArchives.ts"
        }
      ],
      "tags": [
        "ts"
      ],
      "id": "file:apps/web/src/domain/chessComArchives.ts",
      "kind": "file",
      "label": "chessComArchives.ts",
      "summary": "apps/web/src/domain/chessComArchives.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/domain/chessComSyncConfig.ts",
          "path": "apps/web/src/domain/chessComSyncConfig.ts"
        }
      ],
      "tags": [
        "ts"
      ],
      "id": "file:apps/web/src/domain/chessComSyncConfig.ts",
      "kind": "file",
      "label": "chessComSyncConfig.ts",
      "summary": "apps/web/src/domain/chessComSyncConfig.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/domain/continuousPuzzleSession.ts",
          "path": "apps/web/src/domain/continuousPuzzleSession.ts"
        }
      ],
      "tags": [
        "ts"
      ],
      "id": "file:apps/web/src/domain/continuousPuzzleSession.ts",
      "kind": "file",
      "label": "continuousPuzzleSession.ts",
      "summary": "apps/web/src/domain/continuousPuzzleSession.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "id": "file:apps/web/src/lib/chessComApi.ts",
      "kind": "file",
      "label": "chessComApi.ts",
      "summary": "apps/web/src/lib/chessComApi.ts",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      "references": [
        {
          "type": "file",
          "label": "apps/web/src/lib/runtimeGateway.tsx",
          "path": "apps/web/src/lib/runtimeGateway.tsx"
        }
      ],
      "tags": [
        "tsx"
      ],
      "id": "file:apps/web/src/lib/runtimeGateway.tsx",
      "kind": "file",
      "label": "runtimeGateway.tsx",
      "summary": "apps/web/src/lib/runtimeGateway.tsx",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "summary": "Allow a signed-in user to paste or upload PGN, or fetch bounded Chess.com archive PGN by a saved username, and reliably persist reusable remote game records with metadata, deterministic identity, and immediate feedback while retaining read-only cached access offline.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "summary": "Turn analyzed mistakes and blunders into reusable training material and let signed-in users review those puzzles with persistent spaced-repetition progress backed by Convex and mirrored into a local read cache.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "kind": "layer",
      "label": "Adapters",
      "summary": "Bridge application use-cases to Convex persistence, browser caching, worker execution, and UI integration points.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
    ...
    },
    {
      ...
      "id": "risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "kind": "risk",
      "label": "Production SPA deep links are not yet verified to resolve through the hosting layer; Stage 2 found valid non-root routes such as `/library` returning Vercel `404: NOT_FOUND` instead of the SPA shell.",
      "summary": "Production SPA deep links are not yet verified to resolve through the hosting layer; Stage 2 found valid non-root routes such as `/library` returning Vercel `404: NOT_FOUND` instead of the SPA shell.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
      ...
      "id": "risk:production-spa-deep-links-return-host-level-404s",
      "kind": "risk",
      "label": "Production SPA deep links return host-level 404s",
    ...
    },
    {
      ...
      "kind": "tool",
      "label": "Convex/Auth",
      "summary": "Active Convex persistence and Google auth surface used by the shipped web runtime, with IndexedDB retained as a read cache.",
      "lifecycle": "active",
      "system": "external"
    },
    {
    ...
    },
    {
      ...
      "summary": "Give users a reliable way to find previously imported games, reopen them quickly, and continue analysis/review without data loss.",
      "description": "1. User opens library view. 2. System fetches stored games ordered by recent activity, regardless of whether they arrived from paste, upload, or Chess.com archive import. 3. User selects a game to open detailed replay/analysis view. 4. System loads latest analysis summary and per-ply snapshots. 5. User continues replay or reruns analysis as needed.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
      ...
      "summary": "Turn analyzed mistakes and blunders into reusable training material and let signed-in users review those puzzles with persistent spaced-repetition progress backed by Convex and mirrored into a local read cache.",
      "description": "1. User imports a game and opens the game view. 2. User runs browser-side analysis. 3. System stores analysis snapshots in Convex, then derives puzzle candidates from qualifying eval swings. 4. System saves generated puzzles and review metadata in Convex and mirrors them into the local cache. 5. User opens the puzzles view, switches between blunder and mistake tabs, narrows the bank by ownership (`All`, `Mine`, `Other`) and difficulty when needed, or starts continuous mode for personal training. 6. Continuous mode builds an in-memory queue from the user's own puzzles only, serves blunders before mistakes, prioritizes due items before non-due items, and ranks each due-status bucket from weakest to strongest using failures and solve history. 7. User opens a single puzzle card or the continuous queue, attempts the best move, asks for a candidate-piece hint, or reveals the best move while keeping the full stored solution line behind collapsed disclosure. 8. System holds legal-but-suboptimal moves on the board with an error highlight until the user resets or retries, records attempts, animates the reveal/continuation sequence on the board, and in continuous mode short-cycle requeues failed or revealed puzzles later in the same session.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
  ...
  "edges": [
    ...
    {
      "id": "file:apps/web/src/application/chessComImport.ts->touches->layer:application",
      "from": "file:apps/web/src/application/chessComImport.ts",
      "to": "layer:application",
      "kind": "touches"
    },
    {
      "id": "file:apps/web/src/application/chessComSyncCoordinator.ts->touches->layer:application",
      "from": "file:apps/web/src/application/chessComSyncCoordinator.ts",
      "to": "layer:application",
      "kind": "touches"
    },
    {
      "id": "file:apps/web/src/application/importGames.ts->touches->layer:application",
      "from": "file:apps/web/src/application/importGames.ts",
      "to": "layer:application",
      "kind": "touches"
    },
    {
    ...
    {
      "id": "file:apps/web/src/domain/chessComArchives.ts->touches->layer:domain",
      "from": "file:apps/web/src/domain/chessComArchives.ts",
      "to": "layer:domain",
      "kind": "touches"
    },
    {
      "id": "file:apps/web/src/domain/chessComSyncConfig.ts->touches->layer:domain",
      "from": "file:apps/web/src/domain/chessComSyncConfig.ts",
      "to": "layer:domain",
      "kind": "touches"
    },
    {
      "id": "file:apps/web/src/domain/continuousPuzzleSession.ts->touches->layer:domain",
      "from": "file:apps/web/src/domain/continuousPuzzleSession.ts",
      "to": "layer:domain",
      "kind": "touches"
    },
    {
    ...
    {
      "id": "file:apps/web/src/lib/runtimeGateway.tsx->touches->layer:adapters",
      "from": "file:apps/web/src/lib/runtimeGateway.tsx",
      "to": "layer:adapters",
      "kind": "touches"
    },
    {
      "id": "file:apps/web/src/lib/runtimeGateway.tsx->touches->layer:composition",
      "from": "file:apps/web/src/lib/runtimeGateway.tsx",
    ...
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/application/chessComImport.ts",
      "from": "module:web-app",
      "to": "file:apps/web/src/application/chessComImport.ts",
      "kind": "implemented_by"
    },
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/application/chessComSyncCoordinator.ts",
      "from": "module:web-app",
      "to": "file:apps/web/src/application/chessComSyncCoordinator.ts",
      "kind": "implemented_by"
    },
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/application/importGames.ts",
      "from": "module:web-app",
      "to": "file:apps/web/src/application/importGames.ts",
      "kind": "implemented_by"
    },
    {
    ...
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/domain/chessComArchives.ts",
      "from": "module:web-app",
      "to": "file:apps/web/src/domain/chessComArchives.ts",
      "kind": "implemented_by"
    },
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/domain/chessComSyncConfig.ts",
      "from": "module:web-app",
      "to": "file:apps/web/src/domain/chessComSyncConfig.ts",
      "kind": "implemented_by"
    },
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/domain/continuousPuzzleSession.ts",
      "from": "module:web-app",
      "to": "file:apps/web/src/domain/continuousPuzzleSession.ts",
      "kind": "implemented_by"
    },
    {
    ...
    {
      "id": "module:web-app->implemented_by->file:apps/web/src/lib/runtimeGateway.tsx",
      "from": "module:web-app",
      "to": "file:apps/web/src/lib/runtimeGateway.tsx",
      "kind": "implemented_by"
    },
    {
    ...
    {
      "id": "project:web-app->constrained_by->risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "from": "project:web-app",
      "to": "risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "kind": "constrained_by"
    },
    {
      "id": "project:web-app->constrained_by->risk:production-spa-deep-links-return-host-level-404s",
      "from": "project:web-app",
      "to": "risk:production-spa-deep-links-return-host-level-404s",
      "kind": "constrained_by"
    },
    {
    ...
    {
      "id": "project:web-app->uses->tool:convex-auth",
      "from": "project:web-app",
      "to": "tool:convex-auth",
      "kind": "uses"
    },
    ...
    {
      "id": "vertical:v1-import-and-persist-pgn->uses->tool:convex-auth",
      "from": "vertical:v1-import-and-persist-pgn",
      "to": "tool:convex-auth",
      "kind": "uses"
    },
    ...
    {
      "id": "vertical:v3-engine-analysis-and-annotations->uses->tool:convex-auth",
      "from": "vertical:v3-engine-analysis-and-annotations",
      "to": "tool:convex-auth",
      "kind": "uses"
    },
    ...
    {
      "id": "vertical:v4-library-and-game-lifecycle->constrained_by->risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "from": "vertical:v4-library-and-game-lifecycle",
      "to": "risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "kind": "constrained_by"
    },
    {
      "id": "vertical:v4-library-and-game-lifecycle->constrained_by->risk:production-spa-deep-links-return-host-level-404s",
      "from": "vertical:v4-library-and-game-lifecycle",
      "to": "risk:production-spa-deep-links-return-host-level-404s",
      "kind": "constrained_by"
    },
    ...
    {
      "id": "vertical:v4-library-and-game-lifecycle->uses->tool:convex-auth",
      "from": "vertical:v4-library-and-game-lifecycle",
      "to": "tool:convex-auth",
      "kind": "uses"
    },
    ...
    {
      "id": "vertical:v5-puzzle-generation-and-review->uses->tool:convex-auth",
      "from": "vertical:v5-puzzle-generation-and-review",
      "to": "tool:convex-auth",
      "kind": "uses"
    },
    ...
    {
      "id": "vertical:v6-game-view-and-analysis-workbench->constrained_by->risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "from": "vertical:v6-game-view-and-analysis-workbench",
      "to": "risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "kind": "constrained_by"
    },
    {
      "id": "vertical:v6-game-view-and-analysis-workbench->constrained_by->risk:production-spa-deep-links-return-host-level-404s",
      "from": "vertical:v6-game-view-and-analysis-workbench",
      "to": "risk:production-spa-deep-links-return-host-level-404s",
      "kind": "constrained_by"
    },
    ...
    {
      "id": "vertical:v7-backoffice-and-benchmarking->constrained_by->risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "from": "vertical:v7-backoffice-and-benchmarking",
      "to": "risk:production-spa-deep-links-are-not-yet-verified-to-resolve-through-the-hosting-layer-stage-2-found-valid-non-root-routes-such-as-library-returning-vercel-404-not-found-instead-of-the-spa-shell",
      "kind": "constrained_by"
    },
    {
      "id": "vertical:v7-backoffice-and-benchmarking->constrained_by->risk:production-spa-deep-links-return-host-level-404s",
      "from": "vertical:v7-backoffice-and-benchmarking",
      "to": "risk:production-spa-deep-links-return-host-level-404s",
      "kind": "constrained_by"
    },
    ...
    {
      "id": "vertical:v7-backoffice-and-benchmarking->uses->tool:convex-auth",
      "from": "vertical:v7-backoffice-and-benchmarking",
      "to": "tool:convex-auth",
      "kind": "uses"
    },
