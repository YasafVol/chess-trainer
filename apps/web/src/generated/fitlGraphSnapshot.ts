...
export const fitlGraphSnapshot: FitlGraphSnapshot = {
  "version": 1,
  "generatedAt": "2026-03-21T08:41:45.363Z",
  "sourceDocs": [
    "apps/web/README.md",
  ...
  "nodes": [
    ...
    },
    {
      ...
      "summary": "Allow a user to paste or upload PGN, or fetch bounded Chess.com archive PGN by a saved username, and reliably persist reusable local game records with metadata, deterministic identity, and immediate feedback.",
      "lifecycle": "active",
      "system": "internal"
    },
    {
