...
export function toPlyAnalysis(doc: any): PlyAnalysis {
  return {
    ...
    playedMoveEvaluationType: doc.playedMoveEvaluationType,
    playedMoveEvaluation: doc.playedMoveEvaluation,
    playedMoveDepth: doc.playedMoveDepth,
    playedMovePvUci: doc.playedMovePvUci,
