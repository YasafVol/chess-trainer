...
exports.UciParser = void 0;
class UciParser {
    /**
     * Parse UCI analysis output into AnalysisResponse
     */
    static parseAnalysis(output, timingMs) {
        ...
        const linesArray = Array.from(linesMap.entries())
            .sort(([a], [b]) => a - b)
            .map(([, line]) => line);
...
exports.UciParser = UciParser;
//# sourceMappingURL=UciParser.js.map