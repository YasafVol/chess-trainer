...
const stockfishProcess = new StockfishProcess(STOCKFISH_PATH, ENGINE_THREADS, ENGINE_HASH);
...
app.get('/health', async (req: Request, res: Response) => {
	await healthHandler(req, res, stockfishProcess);
});

// Analysis endpoint
app.post('/analyze', async (req: Request, res: Response) => {
	await analyzeHandler(req, res, stockfishProcess);
});
