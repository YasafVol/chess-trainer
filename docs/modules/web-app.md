...
- Vercel production installs intentionally run from `apps/web/package-lock.json` instead of the repo root workspace lock because the workspace-level npm install path has been unstable in Vercel builds.
